...
Downloading https://downloads.arduino.cc/arduino-cli/arduino-cli\_0.22.0\_Linux\_64bit.tar.gz
...
Indicamos los mismos parámetros que antes, la placa con \-b ahora es un parámetro del proceso arduino-board\_fqbn, y la librería que el cliente tradicional requiere que se instale se pasa a la acción como parámetro para que sea descargada.
...
Upacking arduino-cli to /home/runner/arduino\_ide:  ✓
