...
Para versiones anteriores no soportadas, recomendamos actualizar a la versión más reciente para recibir correcciones de seguridad.
...
- **Correo Electrónico**: Envíe un correo electrónico a [antonio.hernan@pruebadeconcepto.es](mailto:antonio.hernan@pruebadeconcepto.es) con detalles sobre la vulnerabilidad. Utilice el asunto "Reporte de Vulnerabilidad de Seguridad".
